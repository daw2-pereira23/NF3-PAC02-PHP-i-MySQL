...
$sSQL = "SELECT count(*) AS total FROM movie WHERE movie_name LIKE '%$buskr%'"; //Cuento el total de registros
$result = mysqli_query($db,$sSQL);
$row = mysqli_fetch_array($result);
$totalRegistros = $row['total']; //Almaceno el total en una variable

$noPaginas = $totalRegistros/$noRegistros; //Determino la cantidad de paginas

?>
<tr>
    <td colspan="2" style="align:center"><?php echo "<strong>Total registros: </strong>".$totalRegistros;?></td>
